  ...
  return (
    <div className={style.wrapper}>
      ...
      <form className={style.form}>
        ...
        <label htmlFor="1" className={style.labelEmail}>Почта</label>
        <input type="text" id='1' placeholder='productname@gmail.ru' name='email' className={style.input}/>
        <label htmlFor="1" className={style.labelEPassword}>Пароль</label>
        <input type="text" id='1' placeholder='productname@gmail.ru' name='password' className={style.input}/>
